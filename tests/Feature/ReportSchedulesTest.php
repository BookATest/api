...
class ReportSchedulesTest extends TestCase
{
    ...
    public function test_guest_cannot_delete_one()
    {
        ...
        $response = $this->json('DELETE', "/v1/report-schedules/$reportSchedule->id");

        $response->assertStatus(Response::HTTP_UNAUTHORIZED);
    }

    public function test_cw_cannot_delete_someone_elses()
    {
        $clinic = factory(Clinic::class)->create();
        $user = factory(User::class)->create()->makeCommunityWorker($clinic);
        $reportSchedule = factory(ReportSchedule::class)->create();
    ...
    public function test_cw_can_delete_their_own()
    {
        ...
        $response->assertStatus(Response::HTTP_OK);
        $this->assertModelDeleted($reportSchedule);
    }
}
